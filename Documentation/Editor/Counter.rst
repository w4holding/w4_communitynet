...
The counter content element provides the possibility to set multiple animated counter in a row. In big viewports (desktop) there are 4 columns of counter, the columns stack as the viewport gets smaller (mobile).
...
#. Go to the Folder that you wanted create the counter record.
...
Follow these steps to add a ccounter content element to a page:
